            ...
            (
              <div className='flex flex-col gap-1'>
                ...
                <div className='flex items-center gap-3 my-2'>
                  <button className='border-2 border-blue-600 rounded-3xl px-3 py-1 min-w-[120px] text-blue-600 font-medium hover:bg-blue-600 hover:text-white' onClick={(e)=>handleBuyProduct(e,data?._id)}>Buy</button>
                  <button className='border-2 border-blue-600 rounded-3xl px-3 py-1 min-w-[120px] font-medium text-white bg-blue-600 hover:text-blue-600 hover:bg-white' onClick={(e)=>handleAddToCart(e,data?._id)}>Add To Cart</button>
                </div>
